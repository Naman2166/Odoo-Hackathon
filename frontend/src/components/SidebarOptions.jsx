import { Add } from "@mui/icons-material"; // Corrected import for MUI v5 icons
    ...
    <div className="sidebarOptions">
      <div className="sidebarOption">
        <img
          ...
          alt="History" // Added alt text for accessibility
        />
        <p>History</p>
      </div>
      ...
      <div className="sidebarOption">
        <img
          // It's generally not recommended to use base64 images directly in JSX,
          // especially for static assets. Prefer importing them or using public URLs.
          // However, keeping it as is for now to focus on MUI migration.
          src="data:image/jpeg;base64,"
          alt="Technology" // Added alt text
        />
        <p>Technology</p>
      </div>
